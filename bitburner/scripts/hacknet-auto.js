...
export async function main(ns) {
  ...
  while (true) {
    ...
    for (let i = 0; i < count; i++) {
      ...
      while (stats.level < maxLevel && ns.hacknet.getLevelUpgradeCost(i, 1) <= ns.getPlayer().money) {
      ...
      while (stats.cores < maxCores && ns.hacknet.getCoreUpgradeCost(i, 1) <= ns.getPlayer().money) {
