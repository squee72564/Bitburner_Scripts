...
function ServerControl(props: ServerControlProps): JSX.Element {
  ...
  return (
    <>
      <FloatingPanel>
        <ResizablePanel title="Server Control" onClose={onExit} defaultWidth={560} defaultHeight={460}>
              ...
              <div key={row.name} style={styles.listItem}>
                ...
                {isExpanded && (
                  <div style={styles.expandPanel}>
                    {row.scripts.length === 0 && <div style={styles.muted}>No running scripts.</div>}
        ...
        <div style={styles.footer}>
          <div style={styles.muted}>Total purchased: {purchased}/{limit}</div>
